import type { EventFrame, RequestFrame, ResponseFrame } from "./schema/types.js";
...
export function readGatewayRequestFrameValidationError(frame: RequestFrame): string | null {
